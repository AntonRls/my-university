...
public class UpdateStudentProjectParticipantRolesHandler : IRequestHandler<UpdateStudentProjectParticipantRolesCommand>
{
    private readonly IStudentProjectsRepository _studentProjectsRepository;
    private readonly IUserContextService _userContextService;

    public UpdateStudentProjectParticipantRolesHandler(
    ...
    public async Task Handle(UpdateStudentProjectParticipantRolesCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new ForbiddenException("Только создатель проекта может изменять роли участников.");
        }
        ...
        {
            throw new BadRequestException("Роли можно изменять только у подтверждённых участников.");
        }
    ...
    {
        var uniqueRoleIds = requestedRoleIds
