...
export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/my-university',
  ...
  resolve: {
    alias: [
      ...
      {
        find: /^@shared\/utils\/(.+)$/,
        replacement: resolve(__dirname, 'src/shared/utils/$1'),
      },
      {
        find: '@shared/utils',
  ...
  build: {
    outDir: '../../dist/apps/my-university',
    emptyOutDir: true,
  },
  test: {
    globals: true,
    ...
    coverage: {
      provider: 'v8',
      reportsDirectory: '../../coverage/apps/my-university',
    },
  },
}));
